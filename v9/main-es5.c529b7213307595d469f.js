...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  "./src/app/examples/invisible/invisible-demo.component.ts":
  /*!****************************************************************!*\
    !*** ./src/app/examples/invisible/invisible-demo.component.ts ***!
    \****************************************************************/

  /*! exports provided: InvisibleDemoComponent */

  /***/
  function srcAppExamplesInvisibleInvisibleDemoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "InvisibleDemoComponent", function () {
      return InvisibleDemoComponent;
    });
    /* harmony import */
    ...
    var ng_recaptcha__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ng-recaptcha */
    "./node_modules/ng-recaptcha/__ivy_ngcc__/fesm2015/ng-recaptcha.js");

    var InvisibleDemoComponent = /*#__PURE__*/function () {
      function InvisibleDemoComponent() {
        _classCallCheck(this, InvisibleDemoComponent);

        this.captchaResponse = '';
      }

      _createClass(InvisibleDemoComponent, [{
        key: "resolved",
        value: function resolved(captchaResponse) {
          var newResponse = captchaResponse ? "".concat(captchaResponse.substr(0, 7), "...").concat(captchaResponse.substr(-7)) : captchaResponse;
          this.captchaResponse += "".concat(JSON.stringify(newResponse), "\n");
        }
      }]);
    ...
    InvisibleDemoComponent.ɵfac = function InvisibleDemoComponent_Factory(t) {
      return new (t || InvisibleDemoComponent)();
    };

    InvisibleDemoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: InvisibleDemoComponent,
      selectors: [["recaptcha-demo"]],
      decls: 9,
      vars: 1,
      consts: [["siteKey", "6Ldp0xgUAAAAAF_iIss_hpFaVrjLbPGjwyfJwebB", "size", "invisible", 3, "resolved"], ["captchaRef", "reCaptcha"], [3, "click"]],
      template: function InvisibleDemoComponent_Template(rf, ctx) {
        if (rf & 1) {
          var _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "recaptcha-demo-wrapper");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "re-captcha", 0, 1);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("resolved", function InvisibleDemoComponent_Template_re_captcha_resolved_1_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InvisibleDemoComponent_Template_button_click_3_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InvisibleDemoComponent_Template_button_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r1);
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("reCAPTCHA response log:\n  ", ctx.captchaResponse || "(empty)", "");
        }
      },
      directives: [_demo_wrapper_demo_wrapper_component__WEBPACK_IMPORTED_MODULE_1__["DemoWrapperComponent"], ng_recaptcha__WEBPACK_IMPORTED_MODULE_2__["RecaptchaComponent"]],
      encapsulation: 2
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InvisibleDemoComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  "./src/app/examples/invisible/invisible-demo.data.ts":
  /*!***********************************************************!*\
    !*** ./src/app/examples/invisible/invisible-demo.data.ts ***!
    \***********************************************************/
  ...
  /***/
  function srcAppExamplesInvisibleInvisibleDemoDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/examples/invisible/invisible-demo.main.ts":
  /*!***********************************************************!*\
    !*** ./src/app/examples/invisible/invisible-demo.main.ts ***!
    \***********************************************************/
  ...
  /***/
  function srcAppExamplesInvisibleInvisibleDemoMainTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _invisible_demo_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./invisible-demo.module */
    "./src/app/examples/invisible/invisible-demo.module.ts");
    /* harmony import */
    ...
    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["platformBrowser"]().bootstrapModule(_invisible_demo_module__WEBPACK_IMPORTED_MODULE_1__["DemoModule"]);
    /***/
  ...
  /***/
  function srcAppExamplesInvisibleInvisibleDemoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _demo_wrapper_demo_wrapper_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../demo-wrapper/demo-wrapper.component */
    "./src/app/demo-wrapper/demo-wrapper.component.ts");
    /* harmony import */


    var _demo_wrapper_demo_wrapper_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../demo-wrapper/demo-wrapper.module */
    "./src/app/demo-wrapper/demo-wrapper.module.ts");
    /* harmony import */


    var _invisible_demo_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./invisible-demo.component */
    "./src/app/examples/invisible/invisible-demo.component.ts");
    /* harmony import */


    var _invisible_demo_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./invisible-demo.data */
    "./src/app/examples/invisible/invisible-demo.data.ts");
    ...
    DemoModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: DemoModule,
      bootstrap: [_invisible_demo_component__WEBPACK_IMPORTED_MODULE_5__["InvisibleDemoComponent"]]
    });
    DemoModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [{
        provide: _demo_wrapper_demo_wrapper_component__WEBPACK_IMPORTED_MODULE_3__["PAGE_SETTINGS"],
        useValue: _invisible_demo_data__WEBPACK_IMPORTED_MODULE_6__["settings"]
      }],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], ng_recaptcha__WEBPACK_IMPORTED_MODULE_2__["RecaptchaModule"], _demo_wrapper_demo_wrapper_module__WEBPACK_IMPORTED_MODULE_4__["DemoWrapperModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](DemoModule, {
        declarations: [_invisible_demo_component__WEBPACK_IMPORTED_MODULE_5__["InvisibleDemoComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], ng_recaptcha__WEBPACK_IMPORTED_MODULE_2__["RecaptchaModule"], _demo_wrapper_demo_wrapper_module__WEBPACK_IMPORTED_MODULE_4__["DemoWrapperModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  0:
  /*!*****************************************************************!*\
    !*** multi ./src/app/examples/invisible/invisible-demo.main.ts ***!
    \*****************************************************************/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/dethariel/Code/ng-recaptcha/demo/v9/src/app/examples/invisible/invisible-demo.main.ts */
    "./src/app/examples/invisible/invisible-demo.main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
//# sourceMappingURL=main-es5.c529b7213307595d469f.js.map