...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  "./src/app/examples/global-config/global-config-demo.component.ts":
  /*!************************************************************************!*\
    !*** ./src/app/examples/global-config/global-config-demo.component.ts ***!
    \************************************************************************/

  /*! exports provided: GlobalConfigDemoComponent */

  /***/
  function srcAppExamplesGlobalConfigGlobalConfigDemoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GlobalConfigDemoComponent", function () {
      return GlobalConfigDemoComponent;
    });
    /* harmony import */
    ...
    var GlobalConfigDemoComponent = /*#__PURE__*/function () {
      function GlobalConfigDemoComponent() {
        _classCallCheck(this, GlobalConfigDemoComponent);
      }

      _createClass(GlobalConfigDemoComponent, [{
        key: "resolved",
    ...
    GlobalConfigDemoComponent.ɵfac = function GlobalConfigDemoComponent_Factory(t) {
      return new (t || GlobalConfigDemoComponent)();
    };

    GlobalConfigDemoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: GlobalConfigDemoComponent,
      selectors: [["recaptcha-demo"]],
      decls: 2,
      vars: 0,
      consts: [[3, "resolved"]],
      template: function GlobalConfigDemoComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("resolved", function GlobalConfigDemoComponent_Template_re_captcha_resolved_1_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GlobalConfigDemoComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  "./src/app/examples/global-config/global-config-demo.data.ts":
  /*!*******************************************************************!*\
    !*** ./src/app/examples/global-config/global-config-demo.data.ts ***!
    \*******************************************************************/
  ...
  /***/
  function srcAppExamplesGlobalConfigGlobalConfigDemoDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var settings = {
      ...
      content: {
        ...
        html: "<span class=\"hljs-tag\">&lt;<span class=\"hljs-name\">recaptcha-demo-wrapper</span>&gt;</span>\n  <span class=\"hljs-tag\">&lt;<span class=\"hljs-name\">re-captcha</span> (<span class=\"hljs-attr\">resolved</span>)=<span class=\"hljs-string\">&quot;resolved($event)&quot;</span>&gt;</span><span class=\"hljs-tag\">&lt;/<span class=\"hljs-name\">re-captcha</span>&gt;</span>\n<span class=\"hljs-tag\">&lt;/<span class=\"hljs-name\">recaptcha-demo-wrapper</span>&gt;</span>\n",
  ...
  /***/
  "./src/app/examples/global-config/global-config-demo.main.ts":
  /*!*******************************************************************!*\
    !*** ./src/app/examples/global-config/global-config-demo.main.ts ***!
    \*******************************************************************/
  ...
  /***/
  function srcAppExamplesGlobalConfigGlobalConfigDemoMainTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _global_config_demo_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./global-config-demo.module */
    "./src/app/examples/global-config/global-config-demo.module.ts");
    /* harmony import */
    ...
    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["platformBrowser"]().bootstrapModule(_global_config_demo_module__WEBPACK_IMPORTED_MODULE_1__["DemoModule"]);
    /***/
  ...
  /***/
  function srcAppExamplesGlobalConfigGlobalConfigDemoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _global_config_demo_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./global-config-demo.component */
    "./src/app/examples/global-config/global-config-demo.component.ts");
    /* harmony import */


    var _global_config_demo_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./global-config-demo.data */
    "./src/app/examples/global-config/global-config-demo.data.ts");
    ...
    DemoModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: DemoModule,
      bootstrap: [_global_config_demo_component__WEBPACK_IMPORTED_MODULE_5__["GlobalConfigDemoComponent"]]
    });
    DemoModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [{
        provide: ng_recaptcha__WEBPACK_IMPORTED_MODULE_2__["RECAPTCHA_SETTINGS"],
        useValue: globalSettings
      }, {
        provide: _demo_wrapper_demo_wrapper_component__WEBPACK_IMPORTED_MODULE_3__["PAGE_SETTINGS"],
        useValue: _global_config_demo_data__WEBPACK_IMPORTED_MODULE_6__["settings"]
      }],
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](DemoModule, {
        declarations: [_global_config_demo_component__WEBPACK_IMPORTED_MODULE_5__["GlobalConfigDemoComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], ng_recaptcha__WEBPACK_IMPORTED_MODULE_2__["RecaptchaModule"], _demo_wrapper_demo_wrapper_module__WEBPACK_IMPORTED_MODULE_4__["DemoWrapperModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  0:
  /*!*************************************************************************!*\
    !*** multi ./src/app/examples/global-config/global-config-demo.main.ts ***!
    \*************************************************************************/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/dethariel/Code/ng-recaptcha/demo/v9/src/app/examples/global-config/global-config-demo.main.ts */
    "./src/app/examples/global-config/global-config-demo.main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
//# sourceMappingURL=main-es5.24a4b409657bef9a4172.js.map